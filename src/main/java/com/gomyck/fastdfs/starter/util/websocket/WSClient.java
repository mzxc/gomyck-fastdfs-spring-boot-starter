...
package com.gomyck.fastdfs.starter.util.websocket;
...
public abstract class WSClient extends WebSocketClient {
    ...
    @Builder
    private static void init(URI serverUri, Draft protocolDraft, Map<String, String> httpHeaders, int connectTimeout) {}
